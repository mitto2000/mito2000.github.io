...
_.every = function(collection, test) {
    if (!test) {
        ...
        for (var i = 0; i < collection.length; i++) {
            ...
            else if (test(collection[i], i, collection) === false) {
                return false;
            }
        }
    }
        ...
        for (var key in collection) {
            ...
            else if (test(collection[key], key, collection) === false) {
                return false;
            }
        }
    }
 ...
 */
 _.pluck = function(objArr, prop) {
  ...
  final = _.map(objArr, function(objectInArr, i, objArr) {
      return objectInArr[prop];
  });
